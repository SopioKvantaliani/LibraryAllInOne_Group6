...
public class APIStepDefs {
    ...
    @Given("I logged Library api as a {string}_FF")
    ...
    @Given("Accept header is {string}_FF")
    public void accept_header_is(String acceptHeader) {
        givenPart.accept(acceptHeader);
    }


    @When("I send GET request to {string} endpoint_FF")
    ...
    @Then("status code should be {int}_FF")
    ...
    @Then("Response Content type is {string}_FF")
    public void response_content_type_is(String contentType) {
        jp = response.then().contentType(contentType).extract().jsonPath();
    }

    @Then("Each {string} field should not be null_FF")
    ...
    @Given("Path param {string} is {string}_FF")
    ...
    @Then("{string} field should be same with path param_FF")
    ...
    @Then("following fields should not be null_FF")
    ...
    @When("I send POST request to {string} endpoint_FF")
    public void i_send_post_request_to_endpoint(String endpoint) {
        response = givenPart.when().post(endpoint).prettyPeek();
    }


    @Then("the field value for {string} path should be equal to {string}_FF")
    ...
    @Then("{string} field should not be null_FF")
    ...
    @Then("UI, Database and API created book information must match_FF")
    ...
    @Then("created user information should match with Database_FF")
    ...
    @Given("I logged Library api with credentials {string} and {string}_FF")
    ...
    @Given("I send {string} information as request body_FF")
