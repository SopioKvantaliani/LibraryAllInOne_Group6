package com.library.steps.sopio;
...
public class APIStepDefs {
    ...
    @Given("I logged Library api as a {string}_SK")
    ...
    @Given("Accept header is {string}_SK")
    public void accept_header_is(String acceptHeader) {
        givenPart.accept(acceptHeader);
    }


    @When("I send GET request to {string} endpoint_SK")
    ...
    @Then("status code should be {int}_SK")
    ...
    @Then("Response Content type is {string}_SK")
    public void response_content_type_is(String contentType) {
        jp = response.then().contentType(contentType).extract().jsonPath();
    }

    @Then("Each {string} field should not be null_SK")
    ...
    @Given("Path param {string} is {string}_SK")
    ...
    @Then("{string} field should be same with path param_SK")
    ...
    @Then("following fields should not be null_SK")
    ...
    @When("I send POST request to {string} endpoint_SK")
    public void i_send_post_request_to_endpoint(String endpoint) {
        response = givenPart.when().post(endpoint).prettyPeek();
    }


    @Then("the field value for {string} path should be equal to {string}_SK")
    ...
    @Then("{string} field should not be null_SK")
    ...
    @Then("UI, Database and API created book information must match_SK")
    ...
    @Then("created user information should match with Database_SK")
    ...
    @Given("I logged Library api with credentials {string} and {string}_SK")
    ...
    @Given("I send {string} information as request body_SK")
